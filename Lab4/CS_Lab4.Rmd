...
ggplot(data = plot_data_1_2, aes(x = 1:length(x_t), y = x_t2)) +
  geom_line() + ggtitle("Metropolis-Hastings Sampler") + ylab("x(t)") + xlab("i")
```
...
t_max = 1000 # number of max iterations
...
MCMC_10seq_test = as.list(MCMC_10seq)
MCMC_10seq_test2 = mcmc.list()
MCMC_10seq_test2 = as.mcmc(MCMC_10seq[1]) 

gelman.diag(MCMC_10seq_test2)

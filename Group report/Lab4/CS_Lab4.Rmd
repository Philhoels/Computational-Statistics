...
\propto&~~\exp \Big(-\frac{(y_1-\mu_1)^2}{2\sigma^2})~~,
\end{aligned}
$$
and
$$
...
\propto&~~ \exp(-\frac{(\mu_i-(y_i+\mu_{i-1}+\mu_i)/{3})^2}{2\sigma^2/3}), ~~i\in(1,n).
\end{aligned}
$$
...
\begin{array}{rcl}
N(y_1,0.2)     &      & i=1\\
N(\frac{y_i+\mu_{i-1}+\mu_i}{3},\frac{0.2}{3})       &      & Otherwise\\
N(\frac{y_i+\mu_{i-1}}{2},0.1)       &      & i=n

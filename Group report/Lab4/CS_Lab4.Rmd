...
=&~~ \frac{1}{\sqrt{0.4\pi}}\exp(-\frac{(\mu_i-(y_i+\mu_{i-1})/{2})^2}{0.2}), ~~i>1,
\end{aligned}
$$
where
$$
p(\mu_1|\vec\mu_{-1},\vec{Y})=\frac{1}{\sqrt{0.4\pi}}\exp(\frac{(y_1-\mu_1)^2}{0.4}).
$$
The deduction shows that 
$$ 
(\mu_i|\vec\mu_{-i},\vec{Y})\sim\left\{
\begin{array}{rcl}
N(\frac{y_i-\mu_{i-1}}{2},0.1)       &      & i>1\\
N(y_1,0.2)     &      & i=1
\end{array} \right. 
$$

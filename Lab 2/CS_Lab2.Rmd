...
#opti_BFGS_gr
opti_BFGS_gr_vector =  data.frame("BFGS", "True", opti_BFGS_gr$convergence, opti_BFGS_gr$par[1],opti_BFGS_gr$par[2],opti_BFGS_gr$counts[1],opti_BFGS_gr$counts[2])
#opti_CG
opti_CG_vector =  data.frame("CG", "Flase", opti_CG$convergence, opti_CG$par[1],opti_CG$par[2],opti_CG$counts[1],opti_CG$counts[2])
#opti_CG_gr
opti_CG_gr_vector =  data.frame("CG", "Flase", opti_CG_gr$convergence, opti_CG_gr$par[1],opti_CG_gr$par[2],opti_CG_gr$counts[1],opti_CG_gr$counts[2])

# create data frame result
result_dataframe = data.frame(matrix(ncol = 7, nrow = 0))
...
colnames(result_dataframe) = colnames_result_dataframe

result_dataframe = do.call(rbind.data.frame()) rbind(result_dataframe,unlist(opti_BFGS_vector))
result_dataframe = rbind(result_dataframe,unlist(opti_BFGS_gr_vector))
result_dataframe = rbind(result_dataframe,opti_CG_vector)
result_dataframe = rbind(result_dataframe,opti_CG_gr_vector)
